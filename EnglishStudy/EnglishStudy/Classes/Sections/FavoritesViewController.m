...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    song.tblID = [[[UserDataManager sharedManager].listFavorites objectAtIndex:indexPath.row] intValue];
...
{
    int tblId = [[[[UserDataManager sharedManager] listFavorites] objectAtIndex:indexPath.row] intValue];
    Song *song = [[Song alloc] init];
    song.tblID = tblId;
    song = [song getSongById:[DatabaseManager sharedDatabaseManager].database];
